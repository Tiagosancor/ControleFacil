    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TransactionSeries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TransactionSeries_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Transactions_TransactionSeries_SeriesId",
                        column: x => x.SeriesId,
                        principalTable: "TransactionSeries",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_UserId_EntryDate",
                table: "Transactions",
                columns: new[] { "UserId", "EntryDate" });

            migrationBuilder.CreateIndex(
                name: "IX_TransactionSeries_UserId",
                table: "TransactionSeries",
                column: "UserId");
