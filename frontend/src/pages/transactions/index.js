    ...
    <AppLayout>
      ...
      <Card className="mb-6">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 [&>div]:min-w-0">
          ...
          {/* Em telas pequenas, De/Até ocupam a linha inteira cada um — dá mais folga
              visual, ainda que o DateField abaixo não dependa mais disso pra não
              estourar (ele mesmo controla a própria largura/arredondamento). */}
          <div className="col-span-2 md:col-span-1">
            <DateField label="De" value={startDate} onChange={setStartDate} max={endDate || undefined} />
          </div>
          <div className="col-span-2 md:col-span-1">
            <DateField label="Até" value={endDate} onChange={setEndDate} min={startDate || undefined} />
          </div>
        </div>
